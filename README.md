...
6. In the `ios` folder, create a file named `Podfile` with the following content, or merge into your existing `Podfile`:
    ...
    target 'yourAppName' do
      ...
      use_frameworks!
      pod 'PureSDK', :podspec => 'https://puresdk.azurewebsites.net/cocoapods/versions/1.0.90?key=<PWD>'
    ...
    Include `pod 'PureSDKBluetooth', :podspec => 'https://puresdk.azurewebsites.net/cocoapods/bluetooth/versions/1.0.90?key=<PASSWORD>` to collect Eddystone UID and Eddystone URL.
